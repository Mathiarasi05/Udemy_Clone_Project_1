...
This project is a *simple Udemy homepage clone* created using *pure HTML and CSS*.  
The goal of this project was to practice layout design, styling, and structuring a webpage without JavaScript or advanced CSS effects.

>> This is an educational clone and not affiliated with Udemy.

---

## Features
- Clean layout inspired by the Udemy homepage
- Header section with logo, search bar, and navigation text
- Categories section with purple pill-shaped tags  
- Hero section with banner image
- Course-card style content blocks (static)  
- Basic responsive arrangement using flexbox  
- Only HTML + CSS (no hover effects, no JS, no interactive elements)
